...
async function deleteQuiz(quizId) {
    try {
        ...
        showFeedbackModal({ title: 'Quiz removido', message: 'O quiz foi removido com sucesso.' });
    } catch (error) {
        console.error('Erro ao remover quiz:', error);
        showFeedbackModal({ title: 'Falha ao remover quiz', message: error.message || 'Não foi possível remover o quiz.', type: 'error' });
    }
};
